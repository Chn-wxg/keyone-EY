...
以root用户执行命令：<br/>
</p><pre><code>wget -N --no-check-certificate "https://raw.githubusercontent.com/Chn-wxg/keyone-EY/master/keyone-EY.sh" && chmod +x keyone-EY.sh && ./keyone-EY.sh</code></pre>
